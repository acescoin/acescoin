...
int64 nChainStartTime = 1461569422;
...
const string strMessageMagic = "acescoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in acescoin
    bool fStrictPayToScriptHash = true; // Always active in acescoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "acescoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "acescoin vector empty mapBlockIndex acescoin";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 529317 : 529317;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
		assert(block.hashMerkleRoot == uint256("0xae5a92f1f49d9b7cd9df9653a9f5baf1f8ce39ac4077a162ef8aedcb8d2faeb4"));
...
unsigned char pchMessageStart[4] = { 0xce, 0xc7, 0xa6, 0xdb };
